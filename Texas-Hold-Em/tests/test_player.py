...
class PlayerTest(unittest.TestCase):
    ...
    def test_stores_name_and_hand(self):
        hand = Hand()
        player = Player(name = "Nick", hand = hand)
        self.assertEqual(player.name, "Nick")
    ...
    def test_figures_out_own_best_hand(self):
        ...
        player = Player(name = "Nick", hand = mock_hand)
    ...
    def test_passses_new_cards_to_hand(self):
        mock_hand = MagicMock()
    ...
    def test_decides_to_continue_or_drop_out_of_game(self):
        player = Player(name = "Kim", hand = Hand())
    ...
    def test_is_sorted_by_best_hand(self):
        ...
        player1 = Player(name = "Nick", hand = mock_hand1)
        player2 = Player(name = "Kim", hand = mock_hand2)
