...
class GameTest(unittest.TestCase):
    def setUp(self): # runs before every individual test
    ...
    def test_stores_deck_and_playrers(self):
        deck = MagicMock()
    ...
    def test_deals_two_initial_cards_from_deck_to_each_player(self):
        ...
        # When remove_cards is invoked, it'll return first_two_cards then next_two_cards
        ...
        # testing that remove cards has been called twice as we have 2 players; the argument that was given to remove cards was 2
