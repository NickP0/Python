...
class HandTest(unittest.TestCase):
    ...
    def test_shows_all_cards_in_tech_repr(self):
        cards = [
    ...
    def test_interacts_with_validator_to_get_winning_hand(self):
        class HandwithOneValidator(Hand): #subclass of Hand
            VALIDATORS = (PairValidator,) # tuple of one element
        ...
        ) # index position, String, cards that make up pair
  
        # testing the iteration of our best rank method by only invoking one validator